...
@section('content')
    <div class="col-10 text-center text-white bg-dark shadow-sm rounded-bottom">
        ...
        <p class="lead p-1 m-0" style="font-size: 22px">NOVO EMPREGADO:</p>
    </div>

    <div class="row col-12 d-flex justify-content-center mt-2 ">
        <form class="col-12 mt-2" action="{{Route('empregado.store')}}" method="post">
            @csrf
            <div class="form-group bg-light p-2 rounded">
                <label for="cep">Nome:</label>
                <input type="text" class="form-control" id="cep" placeholder="Insira o nome do Empregado" name="nome" required>
